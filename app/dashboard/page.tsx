...
<a href="/clientes" className="bg-white rounded-2xl shadow border p-6 hover:shadow-xl">
...
<a href="/pagos" className="bg-white rounded-2xl shadow border p-6 hover:shadow-xl">
<h2 className="text-2xl font-bold text-black mb-2">
💰 Pagos
</h2>
<p className="text-zinc-600">
...
<a href="/entrenadores" className="bg-white rounded-2xl shadow border p-6 hover:shadow-xl">
<h2 className="text-2xl font-bold text-black mb-2">
🏋️ Entrenadores
</h2>
<p className="text-zinc-600">
...
<a href="/clases" className="bg-white rounded-2xl shadow border p-6 hover:shadow-xl">
<h2 className="text-2xl font-bold text-black mb-2">
📅 Clases
</h2>
<p className="text-zinc-600">
...
<a href="/horarios" className="bg-white rounded-2xl shadow border p-6 hover:shadow-xl">
<h2 className="text-2xl font-bold text-black mb-2">
🗓️ Horarios
</h2>
<p className="text-zinc-600">
Organizá los horarios de profesores.
</p>
</a>
